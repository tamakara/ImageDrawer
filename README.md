...
**BaKaBooru** 是一款深度融合 **AI 视觉识别**与 **LLM 语义解析**的本地图片管理工具。它旨在解决海量非结构化图片（插画、设计稿、摄影作品、AI 生成图）的管理难题。通过内置的端侧推理引擎，BaKaBooru 能瞬间理解图片内容并将其转化为可检索、可管理的**智能语义资产**，让您杂乱的文件夹瞬间变身井井有条的个人灵感库。
